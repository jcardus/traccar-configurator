...
<Sidebar
        ...
        asideClass="fixed sm:static inset-0 z-30 min-h-full w-64 lg:h-auto border-e border-gray-200 dark:border-gray-600 lg:overflow-y-visible lg:pt-16 lg:block"
>
